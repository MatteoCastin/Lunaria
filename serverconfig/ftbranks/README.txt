...
Last README file update: Mon Oct 24 09:53:41 CEST 2022
...
command.btga
command.btga.equip
command.btga.equip.flux_armor
command.btga.equip.mekasuit
command.btga.equip.spacesuit1
command.btga.equip.spacesuit2
command.btga.planetselection
command.bwncr
...
command.chickenchunks
command.chickenchunks.restrict
command.chickenchunks.restrict.player
command.chickenchunks.restrict.player.players
command.chickenchunks.restrict.player.players.allow_offline
command.chickenchunks.restrict.player.players.allow_offline.disable
command.chickenchunks.restrict.player.players.allow_offline.enable
command.chickenchunks.restrict.player.players.allow_offline.reset
command.chickenchunks.restrict.player.players.allow_offline.toggle
command.chickenchunks.restrict.player.players.allowed_chunks
command.chickenchunks.restrict.player.players.allowed_chunks.allowed_chunks
command.chickenchunks.restrict.player.players.allowed_chunks.reset
command.chickenchunks.restrict.player.players.chunks_per_loader
command.chickenchunks.restrict.player.players.chunks_per_loader.chunks_per_loader
command.chickenchunks.restrict.player.players.chunks_per_loader.reset
command.chickenchunks.restrict.player.players.offline_timeout
command.chickenchunks.restrict.player.players.offline_timeout.reset
command.chickenchunks.restrict.player.players.offline_timeout.timeout
command.chickenchunks.restrict.player.players.reset
command.clear
...
command.crafttweaker.dump.sushigocrafting_food_ingredients
...
command.ct.dump.sushigocrafting_food_ingredients
...
command.locate.boss_tools:alien_village
command.locate.boss_tools:crimson_village
command.locate.boss_tools:meteor
command.locate.boss_tools:oil_well
command.locate.boss_tools:venus_bullet
command.locate.boss_tools:venus_tower
command.locate.buried_treasure
command.locate.cavesandcliffs:mineshaft
...
command.ponderjs
command.ponderjs.kubejs
command.ponderjs.kubejs.generate_lang
command.ponderjs.kubejs.postevents
command.ponderjs.kubejs.reload
...
command.reloadconfig.client
command.reloadconfig.common
command.replaceitem
